# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-03-13 10:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.SmallIntegerField(choices=[(11, '新闻'), (12, '通知')], default=11, verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.SmallIntegerField(choices=[(11, '首页')], default=11, verbose_name='展示位置')),
                ('img', models.ImageField(upload_to='slider', verbose_name='图片地址')),
                ('reorder', models.SmallIntegerField(default=0, help_text='数字越大,越靠前', verbose_name='排序')),
                ('start_time', models.DateTimeField(blank=True, null=True, verbose_name='生效时间')),
                ('end_time', models.DateTimeField(blank=True, null=True, verbose_name='结束时间')),
